...
/**
 * Testes de persistência básicos para garantir que o banco H2 (profile test)
 * está funcionando: CRUD básico para a entidade Player e verificação de
 * constraint de unicidade no username.
 *
 * Observações:
 * - Usa o profile "test" que inicializa H2 em memória.
 * - Cada teste roda dentro de uma transação que será rollbackada ao final.
 */
@SpringBootTest
@ActiveProfiles("test")
@Transactional
