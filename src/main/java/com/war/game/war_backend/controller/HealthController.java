...
public class HealthController {
    ...
    @GetMapping
    @Operation(summary = "Verifica a saúde da aplicação", description = "Verifica a conexão com o banco de dados e retorna métricas básicas da aplicação")
    ...
    public ResponseEntity<?> healthCheck() {
        ...
        try {
            ...
            logger.info("Healthcheck successful - uptime: {} seconds, duration: {} ms", 
                response.getUptime(), 
            ...
            logger.error("Healthcheck failed - duration: {} ms - error: {}", 
                duration, 
                e.getMessage()
            );
