...
/**
 * Exception lançada quando uma ação é tentada em uma fase de jogo inválida.
 * Por exemplo: tentar atacar durante a fase de REINFORCEMENT.
 * 
 * Essa exceção deve resultar em HTTP 409 CONFLICT no controller.
 */
